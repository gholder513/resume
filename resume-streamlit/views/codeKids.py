...
st.button("CodeKids", key="figma", on_click=lambda: st.write(f"Access here: {website_url}"))
st.button("GitHub Repository", key="github", on_click=lambda: st.write(f"Access here: {github_url}"))
